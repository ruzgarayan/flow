...
Transactions are submitted using a Flow SDK via the [Access API](https://github.com/ruzgarayan/flow/blob/master/docs/access-api-spec.md).
Results can be queried by transaction hash through the [Access API](https://github.com/ruzgarayan/flow/blob/master/docs/access-api-spec.md).
...
Information on Generating Accounts can be found [here](https://github.com/ruzgarayan/flow/blob/master/concepts/accounts-and-keys.md#accounts)
